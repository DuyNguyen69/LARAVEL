                ...
                <div class="col-md-12">
                    <div class="car-details">
                        <div class="img rounded"
                            style="background-image: url({{ asset($car->image ?? 'images/default.jpg') }});"></div>
            ...
            <div class="row">
				@foreach ( $relatedCars as $car )
                    ...
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end" style="background-image: url({{ asset($car->image ?? 'images/default.jpg') }});">
                        </div>
                        <div class="text">
                            ...
                            <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">Book now</a> 
									<a href="{{ route('client.cars.detail', $car->id) }}" class="btn btn-secondary py-2 ml-1">Details</a></p>
                        </div>
                    </div>
                </div>
				@endforeach
