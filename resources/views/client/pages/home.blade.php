                    ...
                    <div class="text w-100 text-center mb-md-5 pb-md-5">
                        ...
                        <a href="https://vimeo.com/45830194"
                            ...
                            <div class="heading-title ml-5">
                                <span>Easy steps for renting self-drive car</span>
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="services-wrap rounded-right w-100">
                                ...
                                <p><a href="{{ route('register') }}" class="btn btn-primary py-3 px-4">Become Member</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="item">
                                <div class="car-wrap rounded ftco-animate">
                                    <div class="img rounded d-flex align-items-end"
                                        style="background-image: url('{{ asset($car->image ?? 'images/default.jpg') }}');">
                                    </div>
                                    <div class="text">
                                        <h2 class="mb-0"><a href="#">{{ $car->name }}</a></h2>
                                        <div class="d-flex mb-3">
                                            <span class="cat">{{ $car->brand }}</span>
                                            <p class="price ml-auto">{{ number_format($car->price_per_day) }}₫
                                                <span>/day</span>
                                            </p>
                                        </div>
                                        <p class="d-flex mb-0 d-block">
                                            {{-- <a href="{{ route('client.rent', $car->id) }}"
                                                class="btn btn-primary py-2 mr-1">Book now</a> --}}
                                            <a href="{{ route('client.cars.detail', $car->id) }}"
                ...
                <div class="col-md-6 wrap-about ftco-animate">
                    <div class="heading-section heading-section-white pl-md-5">
                        ...
                        <p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it
                            ...
                            is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
                        <p><a href="{{ route('client.cars.booking.form') }}" class="btn btn-primary py-3 px-4">Make Your
                                Trip</a></p>
                    </div>
                </div>
            </div>
